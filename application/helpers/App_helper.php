...
if (!function_exists('appApplyStatusList')) {

	function appApplyStatusList() {
...
if (!function_exists('appFieldStatusList')) {

	function appFieldStatusList() {
