...
<div class="border-end bg-white" id="sidebar-wrapper">
	...
	<div class="list-group list-group-flush">
		...
		<a class="list-group-item" href="<?php echo base_url('getDashBoard'); ?>">Dashboard</a>

		<?php if (verifyUserPermission(101)): ?>
			<a class="list-group-item" href="<?php echo base_url('getLevel1ApplicantList'); ?>">Level1 Applicant List</a>
		<?php endif?>

		<?php if (verifyUserPermission(101)): ?>
			<a class="list-group-item" href="<?php echo base_url('getLevel2ApplicantList'); ?>">Level2 Applicant List</a>
		<?php endif?>
