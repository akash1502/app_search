...
$(document).ready(function() {
  ...
  $('#username').on('keyup', function(e) {
    e.preventDefault();
    appHelper.setTextEmptyValidater('username','username_err','Please enter username.');
  });

  $('#password').on('keyup', function(e) {
    e.preventDefault();
    appHelper.setTextEmptyValidater('password','password_err','Please enter password.');
  });
  ...
  $('#login_form').submit(function(e) {
    ...
    var username_Flag = appHelper.setTextEmptyValidater('username','username_err','Please enter username.');
    var password_Flag = appHelper.setTextEmptyValidater('password','password_err','Please enter password.');
